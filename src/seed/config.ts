  ...
  participants: [
    {
      ...
      thirdpartyCallbackUrl: `${scheme}://${baseUrl}/dfspa/thirdparty-sdk/inbound`,
      parties: [
        {
    ...
    },
    {
      ...
      thirdpartyCallbackUrl: `${scheme}://${baseUrl}/dfspb/thirdparty-sdk/inbound`,
      parties: [
        {
    ...
    },
    {
      ...
      fspiopCallbackUrl: `${scheme}://${baseUrl}/pispa/thirdparty-sdk/inbound`,
      thirdpartyCallbackUrl: `${scheme}://${baseUrl}/pispa/thirdparty-sdk/inbound`
    }
  ]
}
